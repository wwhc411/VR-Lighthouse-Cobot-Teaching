...
namespace Valve.VR
{
    public static class SteamVR_Input_Source
    {
        ...
        {
            if (inputSourceHandlesBySource == null)
            {
                Debug.LogWarning("<b>[SteamVR]</b> SteamVR_Input_Source not initialized. Attempting to initialize now...");
                Initialize();
                if (inputSourceHandlesBySource == null)
                {
                    Debug.LogError("<b>[SteamVR]</b> Failed to initialize SteamVR_Input_Source. Returning 0.");
                    return 0;
                }
            }
