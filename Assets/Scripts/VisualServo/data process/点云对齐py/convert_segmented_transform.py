...
# 默认文件路径（MLS配准）
DEFAULT_MLS_INPUT_JSON = r"E:\Unity cangku\lighthouse_3.4（走数据备份）\Assets\StreamingAssets\工件\mls_transform.json"
DEFAULT_MLS_OUTPUT_JSON = r"E:\Unity cangku\lighthouse_3.4（走数据备份）\Assets\StreamingAssets\工件\mls_transform_robot.json"

# 默认手眼变换矩阵（从用户提供的标定结果）
# Camera to Robot Base Transform (Cam → Base) = T_L^R (灯塔→机械臂)
DEFAULT_HAND_EYE_MATRIX = np.array([
  [0.814609, -0.000226, -0.580010, -0.200980],
  [-0.579999, 0.006039, -0.814595, -0.566403],
  [0.003687, 0.999982, 0.004788, 0.314132],
