...
# ========== 文件路径 ==========
SOURCE_CSV = r"E:\Unity cangku\lighthouse_3.4（走数据备份）\Assets\Scripts\VisualServo\算法\圆形\圆形_tracker2.csv"
TARGET_CSV = r"E:\Unity cangku\lighthouse_3.4（走数据备份）\Assets\Scripts\VisualServo\算法\圆形\圆形_tcp2.csv"
# ========== 配准方法选择 ==========
...
MLS_PARAMS = {
    ...
    "loocv_candidates": [0.15],  # LOOCV候选带宽
