...
DEFAULT_TRANSFORM_PATH = r"E:\Unity cangku\lighthouse_3.4（走数据备份）\Assets\StreamingAssets\工件\mls_transform_robot.json"
...
def main():
    ...
    if len(sys.argv) == 1:
        # 无参数，自动使用默认配置运行
        default_input = r"E:\Unity cangku\lighthouse_3.4（走数据备份）\Assets\StreamingAssets\工件\TRACKER - tcp.csv"
        default_output = r"E:\Unity cangku\lighthouse_3.4（走数据备份）\Assets\StreamingAssets\工件\TRACKER - tcp_transformed.csv"
