...
# 默认文件路径（分段配准）
DEFAULT_INPUT_JSON = r"C:\Users\15421\Desktop\lighthouse_1.12\Assets\StreamingAssets\TrackerRecordings\segmented_transform.json"
DEFAULT_OUTPUT_JSON = r"C:\Users\15421\Desktop\lighthouse_1.12\Assets\StreamingAssets\TrackerRecordings\segmented_transform_robot.json"

# 默认文件路径（MLS配准）
DEFAULT_MLS_INPUT_JSON = r"C:\Users\15421\Desktop\lighthouse_1.12\Assets\StreamingAssets\TrackerRecordings\mls_transform.json"
DEFAULT_MLS_OUTPUT_JSON = r"C:\Users\15421\Desktop\lighthouse_1.12\Assets\StreamingAssets\TrackerRecordings\mls_transform_robot.json"

# 默认手眼变换矩阵（从用户提供的标定结果）
# Camera to Robot Base Transform (Cam → Base) = T_L^R (灯塔→机械臂)
DEFAULT_HAND_EYE_MATRIX = np.array([
  [0.940467, 0.009186, -0.339760, 0.042413],
  [-0.339767, -0.000895, -0.940509, -0.443531],
  [-0.008943, 0.999957, 0.002280, 0.014087],
